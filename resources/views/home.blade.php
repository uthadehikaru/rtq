...
<div class="container max-w-screen-xl mx-auto px-4">
	...
	<div class="text-center mt-12 md:mt-16">
		<a href="{{ route('programs.public') }}" class="inline-block px-8 py-3 bg-green-800 font-medium text-white text-md md:text-lg rounded-md hover:opacity-75 transition ease-in-out duration-300">Lihat semua program</a>
	</div>
</div> <!-- container.// -->
