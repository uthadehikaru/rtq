                ...
                <div class="kt-timeline-v2">
                    <div class="kt-timeline-v2__items  kt-padding-top-25 kt-padding-bottom-30">
                        ...
                        <div class="kt-timeline-v2__item">
                            <a href="{{ route('teacher.schedules.detail', $schedule->id) }}" class="kt-timeline-v2__item-time btn btn-sm btn-icon btn-primary">
                            ...
                            <div class="kt-timeline-v2__item-text  kt-padding-top-5">
                                Jadwal Halaqoh {{ $schedule->batch->name }} pada {{ $schedule->scheduled_at->format('d M Y H:i') }}
