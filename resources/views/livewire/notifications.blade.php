<div>
    <div class="dropdown dropdown-inline" data-toggle="kt-tooltip" title="Notifikasi" data-placement="left">
        <button
            ...
            @if($unread)
            <span class="badge badge-default text-white">{{ $unread }}</span>
            @endif
        </button>
                    ...
                    <div class="tab-pane active show" id="notifications" role="tabpanel" wire:ignore.self>
                        <div>
                            ...
                            <div class="text-center p-2" width="100%">
                                <button type="button" class="btn btn-sm btn-outline text-warning" wire:click="markAsRead">Tandai semua sudah dibaca</button>
                                <div wire:loading><div class="spinner-grow spinner-grow-sm" role="status">
