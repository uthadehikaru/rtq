<div>
    ...
    <div class="kt-portlet">
        ...
        <!--begin::Form-->
        <form class="kt-form" wire:submit="save">
            @csrf
                ...
                <div class="kt-section kt-section--first">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            wire:model.live="payment.payment_method">
                    ...
                    <table class="table">
                        ...
                        @foreach ($payment->details as $i=>$detail)
                            <tr>
                                <td>
                                    <select class="form-control" wire:model.live="payment.details.{{$i}}.period_id">
                        ...
                        @endforeach
                            <tr>
                                <td>
                                    <select class="form-control" wire:model.live="period_id">
