    ...
    <div class="kt-portlet__body">
        ...
        <div class="kt-form kt-form--label-right kt-margin-t-20 kt-margin-b-10">
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <form method="get" action="{{ route('courses.batches.batchmembers.create', [$batch->course_id, $batch->id]) }}">
                        @csrf
                        <div class="row">
                            <label class="col-form-label col-md-3 col-sm-12 text-right">@lang('Members')</label>
                            <div class="col-md-7 col-sm-12">
                                <select class="form-control kt-select2" name="member_id">
                                    <option></option>
                            ...
                            <div class="col-md-2 col-sm-12">
                                <button class="btn btn-primary btn-sm" type="submit">@lang('Add')</button>
                            </div>
                        </div>
                    </form>
                </div>
