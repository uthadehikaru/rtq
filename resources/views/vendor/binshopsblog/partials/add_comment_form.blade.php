<div class='add_comment_area'>
    ...
    <form method='post' action='{{route("binshopsblog.comments.add_new_comment",[app('request')->get('locale'),$post->slug])}}'>
        ...
        <div class="form-group ">
            ...
            <label id="comment_label" for="comment">Komentar Anda </label>
                    <textarea
                            class="form-control"
                            name='comment'
                            required
        ...
        <div class='container-fluid'>
            <div class='row'>
                ...
                @if(config("binshopsblog.comments.save_user_id_if_logged_in", true) == false || !\Auth::check())
                    ...
                    <div class='col'>
                        <div class="form-group ">
                            <label id="author_name_label" for="author_name">Nama Anda </label>
                            <input
                                    type='text'
                                    class="form-control"
                                    name='author_name'
                    ...
                    @if(config("binshopsblog.comments.ask_for_author_email"))
                        <div class='col'>
                            <div class="form-group">
                                <label id="author_email_label" for="author_email">Email anda
