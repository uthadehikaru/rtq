    ...
    <div class="blog-item">
        ...
        <div class="blog-inner-item">
            ...
            <div class="post-details-bottom">
                <span class="light-text">Oleh : </span> {{$post->post->author->name}} <span class="light-text">Tanggal : </span> {{date('d M Y ', strtotime($post->post->posted_at))}}
            </div>
            <div class='text-center'>
                <a href="{{$post->url($locale, $routeWithoutLocale)}}" class="btn btn-primary">Lihat</a>
            </div>
        </div>
    </div>
