...
return [
    ...
    'captcha' => [
        ...
        'basic_question' => 'surah pertama dalam al quran?', // a simple captcha question to always ask (if captcha_type is set to 'basic'
        'basic_answers' => 'alfatihah,fatihah,al-fatihah,al fatihah', // comma separated list of possible answers. Don't worry about case.
    ],
    ...
    'comments' => [
        ...
        'max_num_of_comments_to_show' => 10, // max num of comments to show on a single blog post. Set to a lower number for smaller page sizes. No comment pagination is built in yet.
